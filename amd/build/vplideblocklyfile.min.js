  ...
  return function () {
    ...
    this.initRun = function (animate) {
      ...
      var initApi = function (interpreter, scope) {
        ...
        interpreter.setProperty(scope, 'alert', interpreter.createNativeFunction(wrapperAlert));
        ...
        interpreter.setProperty(scope, 'prompt', interpreter.createAsyncFunction(wrapperPrompt));
        ...
        interpreter.setProperty(scope, 'highlightBlock', interpreter.createNativeFunction(wrapperHighlightBlock));
      };
    ...
    this.showStack = function (interpreter) {
      ...
      for (var i = 0; i < stack.length; i++) {
        ...
        if (level.node.type == 'CallExpression') {
          if (self.reservedWords[level.node.callee.name] !== true && level.node.callee.name != undefined) {
            sn++;
    ...
    this.changeCode = function (event) {
      ...
      if (event.type == 'ui' && event.element == 'category' && event.newValue == VPLUtil.str('run')) {
    ...
    this.open = function () {
      this.showFileName();
      if (self.blocklyNotLoaded) {
        VPLUtil.loadScript(['../editor/blockly/blockly_compressed.js', '../editor/blockly/msg/js/en.js', '../editor/blockly/blocks_compressed.js', '../editor/blockly/python_compressed.js', '../editor/blockly/javascript_compressed.js', '../editor/blockly/php_compressed.js', '../editor/blockly/lua_compressed.js', '../editor/blockly/dart_compressed.js', '../editor/acorn/acorn.js', '../editor/acorn/interpreter.js'], function () {
    ...
    this.blocklyStrs = ['basic', 'intermediate', 'advanced', 'variables', 'operatorsvalues', 'control', 'inputoutput', 'functions', 'lists', 'math', 'text', 'run', 'start', 'startanimate', 'stop', 'pause', 'resume', 'step', 'breakpoint', 'selectbreakpoint', 'removebreakpoint'];
